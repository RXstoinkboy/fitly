      ...
      <YStack flex={1} items={'center'} gap={'$4'}>
        ...
        <ScrollView flex={1} width={'100%'}>
          <XStack width={'100%'} gap={'$4'} justify={'space-evenly'}>
            {/* TODO: there should be one more row with rest of the
          pieces of clothes to select by the user */}
            {images.map((image) => {
              return (
                <Button
                  asChild
        ...
        <Button type="primary" stretched disabled={!images.length} onPress={onGenerateImage}>
          Try this look!
        </Button>
      </YStack>
